...
<div id="page-wrapper">
    <div class="row"> 
        ...
        <!--	Banner Start   -->
        <div class="overlay-black w-100 slider-banner1 position-relative" style="background-image: url('images/banner/MTPYEYSKNVOE.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-lg-12">
                          <div class="text-white"> <marquee><h2>
                                We are A full-service Real estate brokerage provides a wide range of professional services to customer, such as tax tip, investment advisory, equity researching,etc.
								</h2></marquee>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-6">
									  ...
									  <div class="col-md-6 col-lg-2">
										...
										<input type="text" class="form-control" id="min" name="min_price" placeholder="Enter Min Price"  required>
                                        <input type="text" class="form-control" id="max" name="max_price" placeholder="Enter Max Price" required>
										</div> 
        ...
        <div class="full-row">
            <div class="container">
                <div class="row">
                   ...
                   <marquee>  <div class="col-md-12">
                        <div class="tab-content mt-4" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home">
                                <div class="row">
								
									<?php $query=mysqli_query($con,"SELECT property.*, user.uname,user.utype,user.uimage FROM `property`,`user` WHERE property.uid=user.uid ORDER BY pid DESC LIMIT 3");
		...
		<!--	Recent Properties  -->
		 ...
		 <!--	Why Choose Us -->
        <div class="full-row living bg-one overlay-secondary-half" style="background-image: url('images/breadcromb.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
            <div class="container">
                <div class="row">
