...
<div id="page-wrapper">
 ...
 ?>
                    <div class="col-lg-4">
                        <h4 class="double-down-line-left text-secondary position-relative pb-4 mb-4 mt-md-50">Send Request</h4>
					  ...
					  <form method="post" action="request1.php">
                            <div class="row">
                                ...
                                <div class="col-md-12">
								  ...
								  <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text"  name="pid1" style="color:black;" class="form-control" value="<?php echo $row['0']; ?>" placeholder="Product Code: <?php echo $row['0']; ?>" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mt-4">
                                        <button type="submit" onclick="myFunction()" name="submit" class="btn btn-primary w-100">Send Request</button>
                                    </div>
                                </div>
                            </div>
                        </form>
...
title,pcontent,type,bhk,stype,bedroom,bathroom,balcony,kitchen,hall,floor,size,price,location,city,state,feature,pimage,pimage1,pimage2,pimage3,pimage4,uid,status,mapimage,topmapimage,groundmapimage,totalfloor,date,request
</html>