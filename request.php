...
if(isset($_POST['add']))
{
	...
	$sql="insert into request (title,pcontent,type,bhk,stype,bedroom,bathroom,balcony,kitchen,hall,floor,size,price,location,city,state,feature,pimage,pimage1,pimage2,pimage3,pimage4,uid,status,mapimage,topmapimage,groundmapimage,totalfloor,request)
	values('$title','$content','$ptype','$bhk','$stype','$bed','$bath','$balc','$kitc','$hall','$floor','$asize','$price',
	'$loc','$city','$state','$feature','$aimage','$aimage1','$aimage2','$aimage3','$aimage4','$uid','$status','$fimage','$fimage1','$fimage2','$totalfloor','$request')";
	$result=mysqli_query($con,$sql);
	if($result)
		{
			$msg="<p class='alert alert-success'>Request Successfully</p>";
					
		}
		else
		{
			$error="<p class='alert alert-warning'>Does Not Request Some Error</p>";
		}
								}
?>
<!DOCTYPE html>
								...
								<div class="description">
									...
									<?php echo $msg; ?>
										...
										<div class="row">
											...
											<input type="submit" value="Request" class="btn btn-primary"name="add" style="margin-left:200px;">
