...
?>  
  <div class="header" style="background-color:rgb(23 201 137);">
			
				<!-- Logo -->
                <div class="header-left">
                    <a href="dashboard.php" class="logo">
						<img src="assets/img/333333.png" alt="Logo">
					</a>
					<a href="dashboard.php" class="logo logo-small">
						<img src="assets/img/333333.png" alt="Logo" width="120" height="100">
					</a>
                </div>
				<!-- /Logo -->
