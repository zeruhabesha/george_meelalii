                                        ...
                                        <table id="datatable-buttons" class="table table-striped dt-responsive nowrap">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
													...
													<td><a href="approve.php?id=<?php echo $row['0'];?>">Approve</a></td>
													<td><a href="approveedit.php?id=<?php echo $row['0'];?>">Edit</a></td>
                                                    <td><a href="approvedelete.php?id=<?php echo $row['0'];?>">Delete</a></td>
                                                </tr>
                                               <?php
					}
												?>
