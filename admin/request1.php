...
<title>George_Meelalii Real Estate</title>
    ...
    <body>
		...
		<!-- Main Wrapper -->
			...
			$query=mysqli_query($con,"SELECT request1.*,property.* FROM `request1`,`property`");
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="header-title mt-0 mb-4">Request View</h4>
                                        ...
                                        <table id="datatable-buttons" class="table table-striped dt-responsive nowrap">
											...
											<?php 	$query=mysqli_query($con,"select * from request1");
													while($row1=mysqli_fetch_row($query))
													{
													
													//$query1=mysqli_query($con,"select property.* from `property`,`request1` where property.pid=request1.pid");
													$query=mysqli_query($con,"SELECT property.*,request1.* from `property`,`request1` where property.pid = request1.pid");
											...
											<tr>
													...
													<td><a href="approve1.php?id=<?php echo $row['0'];?>">Approve</a></td>
                                                    <td><a href="approvedelete1.php?id=<?php echo $row['0'];?>">Delete</a></td>
                                                </tr>
												<?php
													}}
												?>
