...
if(isset($_POST['add']))
{
	...
	$sql = "UPDATE request SET title= '{$title}', pcontent= '{$content}', type='{$ptype}', bhk='{$bhk}', stype='{$stype}',
	...
	totalfloor='{$totalfloor}', request='{$request}' WHERE rid = {$rid}";
						...
						<div class="col-md-12">
							<div class="card">
								...
								<?php
									...
									$rid=$_REQUEST['id'];
									$query=mysqli_query($con,"select * from request where rid='$rid'");
